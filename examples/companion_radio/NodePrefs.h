...
public:
  ...
  char corridor_region[32];   // Flood Corridor compat region for code_1 ("" = "#corridor" pseudo-region)
...
private:
  ...
  protected:
    void structure() override {
      ...
      def("corr_reg", _parent->corridor_region, sizeof(_parent->corridor_region));
